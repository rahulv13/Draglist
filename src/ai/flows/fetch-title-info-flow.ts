...
3.  **Total**: The total number of episodes or chapters.
    ...
    - If the title is a manga and the page lists available chapters, **extract the number of the latest chapter as the total**.
    - If the title is a movie, return 1.
    - If the series is ongoing, still airing, or the total count is not clearly stated after checking for chapters, you must return 1.
